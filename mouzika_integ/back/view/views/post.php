...
<head>
  ...
  <title>Mouzika Dashboard | Dashboard</title>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Connecté en tanq' admin</a>
        </div>
      </div>
						...
						<div class="row">
							<div class="col-lg-10">
								<div class="contact-form">
									...
									<form name="formulaire" onsubmit="" action="ajouter-post.php" onsubmit="verif()" method="POST">
									<div class="row">
										<div class="col-lg-12">
