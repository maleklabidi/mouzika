  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Connecté en tant qu' admin</a>
        </div>
      </div>
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <a href='https://www.stat-counter.org/'>Hit and Visitor Statistics</a> <script type='text/javascript' src='https://www.freevisitorcounters.com/auth.php?id=62f9028ecfa8b435ee36c6cad0a9fa240ba09767'></script>
<script type="text/javascript" src="https://www.freevisitorcounters.com/en/home/counter/827913/t/0"></script>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    <!-- /.content-header -->
    ...
    <div class="container">                               
      ...
      <li class="btn-get-started scrollto" ><a href="post.php">ajouter un article</a></li>
    </div>
