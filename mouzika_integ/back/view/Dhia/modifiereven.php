		...
		<form  method="POST" action="">
            <table align="center">
                <tr>
                    ...
                    <td><input type="text" name="nom" id="nom"  value = "<?php echo $evenement->nom; ?>"></td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="date" name="date" id="date" value="<?php echo $evenement->date;?>" >
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <textarea  name="artiste" id="artiste" rows="5" cols="33" > <?php echo $evenement->artiste;?></textarea>
                    </td>
                </tr>
                <tr>
                    <td>
