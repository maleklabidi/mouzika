...
<body>
	...
	<tbody> 
		<tr>
            <?php
                 echo "<td rowspan='5'>";?> <img src="../../AdminLTE-master/pages/even/view/<?php echo $circ["image"]; ?>"height = "330" width ="330"> <?php echo "</td>";
            ?>
			<td colspan="3"><h5><?PHP echo $circ['nom']; ?></h5></td>
		</tr>
		<tr>
			<td colspan="3" ><h5>Lieu :<?PHP echo $circ['emplacement']; ?></h5><button style="float: right;" class="genric-btn warning" onclick=" window.open('map.html','_blank')"> Ou Exactement?</button></td>
		</tr>
		<tr>
