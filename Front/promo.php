<?PHP
	...
	$listepromo=$promotionC->afficherpromotion(); 
...
<body>
	...
	<tbody> 
		...
		<tr>
			<td colspan="3"><?PHP echo $circ['duree']; ?></td>
		</tr>
		<tr>
			<td colspan="3"><?PHP echo $circ['reduction']; ?>%</td>
		</tr>
		<tr>
			<td colspan="3"><a href="#" class="genric-btn info circle">Ajouter Au Panier</a></td>
		</tr>
	</tbody>
</table>
<br><br>
