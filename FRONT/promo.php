	...
	<div class="whole-wrap">
		<div class="container box_1170">
			<div class="section-top-border">
				<h3 class="mb-30">Liste des Promotions</h3>
				<div class="row">
			...
			?>
				<tr>
					...
					<td><?PHP echo '<img src="data:image/jpeg;base64,'.base64_encode($circ['image']).'" width ="100" height="100" />'; ?></td>
               
					<td><?PHP echo $circ['description']; ?></td>
                    <td><?PHP echo $circ['reduction']; ?></td>
