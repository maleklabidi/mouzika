  ...
  move_uploaded_file($img_loc,"$img_folder/$img");
	...
	if (
		...
		if (!empty($_POST["nomprenom"]) && 
			...
			$artisteC->ajouterartiste($artiste);
...
<head>
  ...
  <title>Mouzika | Ajouter un artiste</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">ajout artiste</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Votre nouvel artiste est:</h3>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4">
                                <div class="form-input">
                                    <label for="nomprenom" class="required">Nom et prenom:</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-input">
                                    ...
                                    <input type="file" name="img" id="img" class="submit"/>
                                </div>
                            </div>
                            </div>
                        </div>
