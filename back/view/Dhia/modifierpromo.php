...
$promotionC = new promotionC();
$pp = $promotionC->recupererpromotion($_GET['id_promo']);
if(isset($_POST['image']))
{
  ...
  $promotionC->modifierpromotion($promotion,$_GET["id_promo"]); 
  header('Location:afficherpromo.php');
}
elseif (!empty($_POST["id_artiste"])) 
{
  $promotion = new promotion(
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Dhia Gabtni</a>
        </div>
      </div>
    ...
    <button><a href="afficherpromo.php">Retour à la liste</a></button>
		...
		<?php
			if (isset($_GET['id_promo'])){
                $promotion = $promotionC->recupererpromotion($_GET['id_promo']);
		...
		<form  method="POST" action="" enctype="multipart/form-data">
            <table align="center">
                <tr>
                    ...
                    <td><input type="text" name="id_artiste" id="id_artiste"  value = "<?php echo $promotion->id_artiste; ?>"></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="text" name="id_even" id="id_even"  value = "<?php echo $promotion->id_even; ?>"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="nom" id="nom"  value = "<?php echo $promotion->nom; ?>">
                    </td>
                </tr>
                <tr>
                <tr>
                    ...
                    <td>
                        <input type="text" name="reduction" id="reduction"  value = "<?php echo $promotion->reduction; ?>">
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="date" name="duree" id="duree" value="<?php echo $promotion->duree;?>" >
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <textarea  name="description" id="description" rows="5" cols="33" > <?php echo $promotion->description;?></textarea>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                    <img src="<?php echo $promotion->image; ?>"height = "230" width ="230">
