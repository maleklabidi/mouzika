      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          {  
            ...
            $fnm=$_FILES["photocours"]["name"];
            $dst="../pdp_cours/".$v3.$fnm;
         
            move_uploaded_file($_FILES["photocours"]["tmp_name"],$dst);


            mysqli_query($link,"INSERT into cours values(NULL ,'$_POST[nomcours]','$_POST[typecours]',$_POST[prixcours],'$_POST[descours]','$dst')");
