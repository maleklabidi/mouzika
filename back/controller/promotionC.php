<?php
	...
	class promotionC {
		...
		function ajouterpromotion($promotion) {
			$sql = "INSERT INTO promotion (id_artiste, id_even, nom, reduction, duree, description, image) VALUES (:id_artiste, :id_even, :nom, :reduction, :duree, :description, :image)";
        ...
        function modifierpromotion($promotion,$id_promo){
			try {
				...
				$query->bindValue(':nom',$promotion->getno());
				$query->bindValue(':id_even',$promotion->getprod());
